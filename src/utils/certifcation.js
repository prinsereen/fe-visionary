...
// Function to find certification information for a specific country and certification code
const findCertification = (countryCode, certificationCode) => {
  const countryCertifications = certificationsData[countryCode];

  if (countryCertifications) {
    const certification = countryCertifications.find(
      (cert) => cert.certification === certificationCode
    );
